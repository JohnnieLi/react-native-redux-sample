...
class PushedScreen extends Component {
    ...
    static navigatorButtons = {
        ...
        fab: {
            collapsedId: 'home',
            collapsedIcon: require('../../img/checkmark.png'),
        ...
        return (
            <ScrollView style={{flex: 1, padding: 20, backgroundColor: this.bgColor}}>
                ...
                <Text style={styles.text}>
                    <Text style={{fontWeight: '500'}}>Counter: </Text> {this.props.app.username}
                </Text>
                ...
                <Text style={{fontWeight: '500'}}>String prop: {this.props.app.username}</Text>
